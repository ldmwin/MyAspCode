		...
		<div id="main">
			...
			<div id="main_left">
				...
				<div id="main_leftnav_box">
					<div class="main_leftnav_text"><a href="index.asp">用车宝典</a></div>
				</div>
			...
			<div id="main_right">
				<div id="main_right_box">
					...
					<div id="news_bottom">		
						...
						<%Sub News()%>
						<%
						sqlstr="select * from [Informations] where status=1 and Info_Type = 5 order by show_order desc,id desc"
