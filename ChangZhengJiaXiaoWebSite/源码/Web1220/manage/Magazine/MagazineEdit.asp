...
picurl1= Config.ImgUrl() & "Magazine/" & rs_Magazine("Pic_View")		
%>
...
<body>
<form name="MagazineEdit" method="post" action="MagazineSave.asp">
	<table border="0" cellspacing="1" cellpadding="5" height="1" align="center" width="100%">
		<tr class="tr2">
			<td align="left" colspan="2">
				...
				<input type="button" name="return" class="button" value="返回" style="margin-left:20px;" onClick="GotoUrl('MagazineView.asp?id=<%=rs_Magazine("id")%>');"/><input type="button" name="refresh" value="刷新" class="button" style="margin-left:20px;"  onClick="Refresh('_self');"/>
				<input type="hidden" name="action" value="edit"><input type="hidden" name="Magazine_ID" value="<%=rs_Magazine("id")%>"></td>
		</tr>
		<tr>
			<th colspan="2" style="text-align:center;">编辑杂志/DM</th>
		</tr>
		<tr class="tr1">
			<td width="30%">标题：</td>
			<td width="70%"><input name="Magazine_Name" type="text" id="Magazine_Name" size="50" value="<%=rs_Magazine("Magazine_Name")%>" />
			*</td>
		</tr>
		...
		<tr class="tr2">
		  ...
		  do until rs.eof
		  response.Write("<option value=""" & rs("id") & """ " & object_selected(rs_Magazine("Magazine_Type"),rs("id")) & ">&nbsp;" & rs("Type_Name") & "&nbsp;</option>")
		  rs.movenext
		  loop
		  end if
		  db.C(rs)
		...
		<tr class="tr1">
		  <td>期数：</td>
		  <td><input name="Magazine_Period" type="text" id="Magazine_Period" size="50" value="<%=rs_Magazine("Magazine_Period")%>" />*</td>
	  </tr>
		<tr class="tr2">
		  <td>有效期：</td>
		  <td><input name="Magazine_Validity" type="text" id="Magazine_Validity" size="50" value="<%=rs_Magazine("Magazine_Validity")%>" /></td>
	  </tr>
		<tr class="tr1">
			<td width="30%">封面：</td>
			<td width="70%"><input name="Pic_View" type="text" id="Pic_View" size="50" value="<%=rs_Magazine("Pic_View")%>" />
		    &nbsp;&nbsp;<div id="PicOperate1" style="display: inline;">&nbsp;&nbsp;<div  id="ReUpload1" onClick="reupload('../inc/UploadPhotos.asp?savepath=Magazine&picshow=ViewPicShow1&picsize=200&picheight=0&picwidth=0&picurl=Pic_View&PicOperate=PicOperate1','PicOperate1','Pic_View','UploadFiles1');" style="cursor:hand;display:inline;" onMouseOver="PicView(0,null,this);" onMouseOut="PicView(1,null,this);">重新上传</div>  <div id="ViewShow1" style="cursor:hand;display:inline;" onMouseOver="PicView(0,'ViewPicShow1',this);" onMouseOut="PicView(1,'ViewPicShow1',this);">预览图片</div></div><img name="ViewPicShow1" id="ViewPicShow1" src="<%=picurl1%>" alt="" style="display:none;"/></td>
		</tr>
		<tr class="tr1">
			<td width="30%">&nbsp;</td>
			<td width="70%"><iframe id="UploadFiles1" src="../inc/UploadPhotos.asp?savepath=Magazine&picshow=ViewPicShow1&picsize=200&picheight=0&picwidth=0&picurl=Pic_View&PicOperate=PicOperate1&pictype=edit" frameborder=0 scrolling=no width="450" height="25" style="margin-top:2px;"></iframe></td>
	  </tr>
		<tr class="tr2">
		  <td>简介：</td>
		  <td><textarea name="Brief" cols="60" rows="6" id="Brief"><%=rs_Magazine("Brief")%></textarea></td>
	  </tr>
		
		<tr class="tr1">
		  <td>显示顺序：</td>
		  <td><input name="Show_Order" type="text" id="Show_Order" value="<%=rs_Magazine("Show_Order")%>" size="10" />
*</td>
	  </tr>
  </table>
</form>
