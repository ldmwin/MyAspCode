...
Dim rs_Page : Set rs_Page = db.getRecordBySQL("select *,(select Magazine_Name from Magazines where Magazines.id = Magazine_Pages.Magazine_ID) as Magazine_Name from Magazine_Pages where status<>4 and id = " & Info_id)
...
picurl2 = Config.ImgUrl() & "Magazine/" & rs_Page("Picture")	
%>
	...
	<table border="0" cellspacing="1" cellpadding="5" height="1" align="center" width="100%">
		<tr class="tr2">
			<td align="left" colspan="2">
				...
				<input type="hidden" name="action" value="edit"><input type="hidden" name="Page_id" value="<%=rs_Page("id")%>"></td>
		</tr>
		<tr>
			<th colspan="2" style="text-align:center;">编辑分页</th>
		</tr>
		<tr class="tr1">
		...
		<tr class="tr2">
			<td width="30%">分页标题：</td>
			<td width="70%"><input name="Title" type="text" id="Title" size="50"  value="<%=rs_Page("Title")%>"/>*</td>
	  </tr>		
		<tr class="tr1">
		  <td>图片：</td>
		  <td><input name="Page" type="text" id="Page" size="50" value="<%=rs_Page("Picture")%>" />
		...
		<tr class="tr1">
		  <td>&nbsp;</td>
		  <td><iframe id="UploadFiles2" src="../inc/UploadPhotos.asp?savepath=Magazine&picshow=ViewPicShow2&picsize=1000&picheight=0&picwidth=0&picurl=Page&PicOperate=PicOperate2&pictype=edit" frameborder=0 scrolling=no width="450" height="25" style="margin-top:2px;"></iframe></td>
	  </tr>
		<tr class="tr2">
		  <td>显示顺序：</td>
		  <td><input name="Show_Order" type="text" id="Show_Order" value="<%=rs_Page("Show_Order")%>" size="10" />
*</td>
	  </tr>
  </table>
</form>
