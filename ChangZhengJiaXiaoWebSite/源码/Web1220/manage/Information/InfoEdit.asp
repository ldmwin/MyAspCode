...
sqlstr = "select *,dbo.StatusShow(1,status) as statusshow,(select type_name from Information_Type where Information_Type.id=Informations.Info_Type) as infotypeshow from Informations where status<>4 and id = " & Info_id
...
<form name="InfoEdit" method="post" action="InfoSave.asp">
	<table border="0" cellspacing="1" cellpadding="5" height="1" align="center" width="100%">
		...
		<tr class="tr2">
			<td width="30%">&nbsp;</td>
			<td width="70%"><iframe id="UploadFiles1" src="../inc/UploadPhotos.asp?savepath=Info&picshow=ViewPicShow1&picsize=200&picheight=0&picwidth=0&picurl=Pic_View&PicOperate=PicOperate1&pictype=edit" frameborder=0 scrolling=no width="450" height="25" style="margin-top:2px;"></iframe></td>
	  </tr>
		<tr class="tr1">
		  <td>摘要：</td>
