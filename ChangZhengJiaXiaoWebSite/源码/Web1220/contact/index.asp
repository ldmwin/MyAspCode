...
<!--主体开始-->
		...
		<div id="main">
			...
			<div id="main_left">
				...
				<div class="main_left_pic"><img src="images/contact_left_pic1.jpg" width="200" height="80" /></div>
				<div class="main_left_pic"><img src="images/contact_left_pic2.jpg" width="200" height="80" /></div>
				<div class="main_left_pic"><img src="images/contact_left_pic3.jpg" width="200" height="80" /></div>
			...
			<div id="main_right">
				<div id="main_right_box">
					...
					<!--<p style="border-bottom:1px solid #999999; width:600px;"><strong>长征驾校联系方式：</strong></p>
					
					<p style="border-bottom:1px dotted #999999; width:600px;">电话：0319-2135478</p>
					<p style="border-bottom:1px dotted #999999; width:600px;">传真：0319-2135478</p>
					<p style="border-bottom:1px dotted #999999; width:600px;">地址：的数据库了福建爱上的路口附近萨多雷空嗟伏生老卡的减肥</p>
					<p style="width:600px; margin-top:40px;"><img src="#" width="500" /></p>-->
					<%=Column_Content%>
