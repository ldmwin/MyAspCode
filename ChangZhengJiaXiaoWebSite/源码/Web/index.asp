		...
		<div id="main1" style="background:#ededed;">
			...
			<div id="index_main_left">
				<div id="index_mainleft_left">
					...
					<div id="index_intro">
						<div id="index_intro_left"><!--<img src="images/index_intro.jpg" width="170" height="120" />--><embed src="http://player.youku.com/player.php/sid/XMzMyNDEzNjcy/v.swf" quality="high" width="170" height="120" align="middle" allowScriptAccess="sameDomain" allowFullscreen="true" type="application/x-shockwave-flash"></embed></div>
