		...
		<div id="main">
			...
			<div id="main_right">
				<div id="main_right_box">
					...
					<div class="honor_pic" style="width:185px; height:auto;"><a href="<%=Config.ImgUrl()%>Pictures/<%=rs_Picture("Picture")%>" target="_blank"><img src="<%=Config.ImgUrl()%>Pictures/<%=rs_Picture("Picture")%>" width="185" height="140" /></a><span style="width:185px;"><%=rs_Picture("Title")%></span></div>
					<%
					  rs_Picture.movenext()
