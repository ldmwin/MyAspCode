		...
		<div id="main_top">
			...
			<div id="main_top_right">
				...
				<div class="main_righttop_title">
					<div class="main_righttop_titleleft"><strong>教练风采</strong> |</div>
		...
		<div id="main">
			...
			<div id="main_right">
				<div id="main_right_box">
					...
					<!--<div class="coach_box">
						<div class="coach_box_left"><img src="#" width="200" height="150" /></div>
						<div class="coach_box_right">
							<div class="coach_box_righttitle">123</div>
							<div class="coach_box_righttext">健康了的设计费洛杉矶的空间杰拉德是减肥了科技las均等分裂空间阿斯顿了福建萨度克</div>
						</div>
						<div style="clear:both;"></div>
					</div>
			...
			<%			
			Dim rs_Picture
			Set rs_Picture = db.getRecordBySQL("select * from [Album_Pictures] where Album_ID=1 and status<>4 order by Show_Order desc,id desc") 
	
				if not (rs_Picture.eof or rs_Picture.bof) then
				do while not rs_Picture.eof%>
				<div class="honor_pic"><a href="<%=Config.ImgUrl()%>Pictures/<%=rs_Picture("Picture")%>" target="_blank"><img src="<%=Config.ImgUrl()%>Pictures/<%=rs_Picture("Picture")%>" width="185" height="140" /></a><span><%=rs_Picture("Title")%></span></div>
				<%
			  rs_Picture.movenext()
