...
<!--主体开始-->
		<div id="main_top">
			<div id="main_top_left">
				<div id="main_top_lefttitle">用车宝典</div>
			...
			<div id="main_top_right">
				...
				<div class="main_righttop_title">
					<div class="main_righttop_titleleft"><strong>用车宝典</strong> |</div>
		...
		<div id="main">
			...
			<div id="main_left">
				...
				<div id="main_leftnav_box">
					<div class="main_leftnav_text"><a href="index.shtml">用车宝典</a></div>
				</div>
				<div style="height:50px;"></div>
				<div class="main_left_pic"><img src="images/canon_left_pic1.jpg" width="200" height="80" /></div>
				<div class="main_left_pic"><img src="images/canon_left_pic2.jpg" width="200" height="80" /></div>
				<div class="main_left_pic"><img src="images/canon_left_pic3.jpg" width="200" height="80" /></div>
			...
			<div id="main_right">
				...
				%>
					...
					<div id="main_right_box">
						<div id="newsdetail_title"><%=rs_News("Title")%></div>
					
						<div id="newsdetail_time"><%response.Write(formatdatetime(rs_News("Add_Time"),2))%></div>
