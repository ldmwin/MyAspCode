...
<!--主体右侧开始-->
			<div id="main_right">
				<div id="contact">
					<div id="contact_left">
						<div id="contact_left_title">产品中心</div>
						<div id="contact_left_box">
                            ...
                            sqlstr = "select * from Products where (status=1 or status=5) and id = " & Info_id
                            
                            Dim rs_Products : Set rs_Products = db.getRecordBySQL(sqlstr)
                            
                            if rs_Products.eof or rs_Products.bof then
                            ...
                            %>
                                    ...
                                    <div class="newsdetail_title"><%=rs_Products("Product_Name")%></div>
                                
                                    <div class="newsdetail_text">
                                    
                                        <%=rs_Products("Introduce")%>
