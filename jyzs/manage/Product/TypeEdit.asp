...
Dim rs_Type : Set rs_Type = db.getRecordBySQL("select *,(select Type_Name from Product_Type a where a.id=c.parent_id) as p_name from Product_Type c where id = " & info_id)
