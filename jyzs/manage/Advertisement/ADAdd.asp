...
<body>
<form name="ADAdd" method="post" action="ADSave.asp">
	<table border="0" cellspacing="1" cellpadding="5" height="1" align="center" width="100%">
		<tr class="tr2">
			<td align="left" colspan="4">
				...
				<input type="button" name="return" class="button" value="返回列表" style="margin-left:20px;" onClick="GotoUrl('ADManage.asp');"/><input type="button" name="refresh" value="刷新" class="button" style="margin-left:20px;"  onClick="Refresh('_self');"/>
				<input type="hidden" name="action" value="add">			</td>
		</tr>
		<tr>
			<th colspan="4" style="text-align:center;">新建页面广告</th>
		</tr>
		<tr class="tr1">
			<td width="20%">广告名称：</td>
			<td width="80%" colspan="3"><input name="Advertisement_Name" type="text" id="Advertisement_Name" size="50" />
			*</td>
		</tr>
		<tr class="tr2">
		...
		<tr class="tr1">
		  ...
		  do until rs.eof
		  response.Write("<option value=" & rs("id") & ">&nbsp;" & rs("Sort_Name") & "&nbsp;</option>")
		  rs.movenext
		  loop
		  end if
		  db.C(rs)
		...
		<tr class="tr1">
			<td>默认链接：</td>
			<td colspan="3" class="tr2"><input name="Default_Link" type="text" id="Default_Link" value="#" size="50" /></td>
      </tr>
		...
		<tr class="tr1">
		  <td>默认宽度(px)：</td>
		  <td><input name="Default_Width" type="text" id="Default_Width" value="0" size="15"  />
		    0为自适应</td>
	      <td>默认高度(px)：</td>
	      <td><input name="Default_Height" type="text" id="Default_Height" value="0" size="15"  />
	        0为自适应</td>
	  </tr>
		<tr class="tr2">
		  <td>自动关闭时间(秒)：</td>
		  <td><input name="Close_Time" type="text" id="Close_Time" value="0" size="15"  />
		    0秒为不关闭</td>
	      <td>展示时间间隔(秒)：</td>
	      <td><input name="Show_Interval" type="text" id="Show_Interval" value="0" size="15"  />
          0秒为每次都出现</td>
	  </tr>
		<tr class="tr1">
		  <td>默认图片：</td>
		  <td colspan="3"><input name="Default_Pic" type="text" id="Default_Pic" size="50"  />
		...
		<tr class="tr1">
		  <td>&nbsp;</td>
		  <td colspan="3"><iframe id="UploadFiles1" src="../inc/UploadPhotos.asp?savepath=AD&picshow=ViewPicShow1&picsize=200&picheight=0&picwidth=0&picurl=Default_Pic&PicOperate=PicOperate1" frameborder=0 scrolling=no width="450" height="25" style="margin-top:2px;"></iframe> </td>
	  </tr>
		<tr class="tr2">
		  <td>默认缩略图：</td>
		  <td colspan="3"><input name="Default_Pic_View" type="text" id="Default_Pic_View" size="50"  />
		...
		<tr class="tr2">
		  <td>&nbsp;</td>
		  <td colspan="3"><iframe id="UploadFiles2" src="../inc/UploadPhotos.asp?savepath=AD&picshow=ViewPicShow2&picsize=200&picheight=0&picwidth=0&picurl=Default_Pic_View&PicOperate=PicOperate2" frameborder=0 scrolling=no width="450" height="25" style="margin-top:2px;"></iframe>&nbsp;</td>
	  </tr>
		<tr class="tr1">
		  <td>简介：</td>
		...
		<tr class="tr2">
		  <td>调用说明：</td>
		  <td colspan="3"><textarea name="Call_Function" cols="60" rows="6" id="Call_Function"></textarea></td>
	  </tr>
