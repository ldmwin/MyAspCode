...
'属性，只读，站点ID	
	...
	Private Sub Class_Initialize()
		TheImgUrl = "http://www.tianyizu.com/"
		TheVideoUrl = ""
		TheSqlUsername = ""
		TheSqlPassword = ""
	...
	Private Function CreatConnStr(ByVal dbType, ByVal strDB, ByVal strServer, ByVal strUid, ByVal strPwd)
		...
		Select Case dbType
			...
			Case "1","ACCESS"
				...
				TempStr = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source="&tDb&";"
				'TempStr = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source="&tDb&";Jet OLEDB:Database Password="&strPwd&";"
				'TempStr = "DRIVER=Microsoft Access Driver (*.mdb);DBQ="&tDb&";"
				 '"Provider = Microsoft.Jet.OLEDB.4.0; Data Source ="&Server.MapPath("sitedata/lioncms.mdb")
			Case "3","MYSQL"
